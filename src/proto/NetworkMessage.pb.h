...
class BattlePrepStartMessage;
class BattlePrepStartMessageDefaultTypeInternal;
extern BattlePrepStartMessageDefaultTypeInternal _BattlePrepStartMessage_default_instance_;
...
class CurrentRankInfoMessage;
class CurrentRankInfoMessageDefaultTypeInternal;
extern CurrentRankInfoMessageDefaultTypeInternal _CurrentRankInfoMessage_default_instance_;
class DataLoadedMessage;
class DataLoadedMessageDefaultTypeInternal;
extern DataLoadedMessageDefaultTypeInternal _DataLoadedMessage_default_instance_;
class EnemyInfoMessage;
class EnemyInfoMessageDefaultTypeInternal;
extern EnemyInfoMessageDefaultTypeInternal _EnemyInfoMessage_default_instance_;
class ExitBroadcastMessage;
class ExitBroadcastMessageDefaultTypeInternal;
extern ExitBroadcastMessageDefaultTypeInternal _ExitBroadcastMessage_default_instance_;
class ExitMessage;
class ExitMessageDefaultTypeInternal;
extern ExitMessageDefaultTypeInternal _ExitMessage_default_instance_;
class ExitPlayerInfo;
class ExitPlayerInfoDefaultTypeInternal;
extern ExitPlayerInfoDefaultTypeInternal _ExitPlayerInfo_default_instance_;
...
extern StartMatchMessageDefaultTypeInternal _StartMatchMessage_default_instance_;
class WaitingPlayerMessage;
class WaitingPlayerMessageDefaultTypeInternal;
extern WaitingPlayerMessageDefaultTypeInternal _WaitingPlayerMessage_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::BattlePrepStartMessage* Arena::CreateMaybeMessage<::BattlePrepStartMessage>(Arena*);
...
template<> ::CurrentRankInfoMessage* Arena::CreateMaybeMessage<::CurrentRankInfoMessage>(Arena*);
template<> ::DataLoadedMessage* Arena::CreateMaybeMessage<::DataLoadedMessage>(Arena*);
template<> ::EnemyInfoMessage* Arena::CreateMaybeMessage<::EnemyInfoMessage>(Arena*);
template<> ::ExitBroadcastMessage* Arena::CreateMaybeMessage<::ExitBroadcastMessage>(Arena*);
template<> ::ExitMessage* Arena::CreateMaybeMessage<::ExitMessage>(Arena*);
template<> ::ExitPlayerInfo* Arena::CreateMaybeMessage<::ExitPlayerInfo>(Arena*);
...
template<> ::StartMatchMessage* Arena::CreateMaybeMessage<::StartMatchMessage>(Arena*);
template<> ::WaitingPlayerMessage* Arena::CreateMaybeMessage<::WaitingPlayerMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
constexpr MessageType MessageType_MAX = DISCONNECTED;
...
class WaitingPlayerMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:WaitingPlayerMessage) */ {
 public:
  inline WaitingPlayerMessage() : WaitingPlayerMessage(nullptr) {};
  virtual ~WaitingPlayerMessage();

  WaitingPlayerMessage(const WaitingPlayerMessage& from);
  WaitingPlayerMessage(WaitingPlayerMessage&& from) noexcept
    : WaitingPlayerMessage() {
    *this = ::std::move(from);
  }

  inline WaitingPlayerMessage& operator=(const WaitingPlayerMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline WaitingPlayerMessage& operator=(WaitingPlayerMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const WaitingPlayerMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const WaitingPlayerMessage* internal_default_instance() {
    return reinterpret_cast<const WaitingPlayerMessage*>(
               &_WaitingPlayerMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    2;

  friend void swap(WaitingPlayerMessage& a, WaitingPlayerMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(WaitingPlayerMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(WaitingPlayerMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline WaitingPlayerMessage* New() const final {
    return CreateMaybeMessage<WaitingPlayerMessage>(nullptr);
  }

  WaitingPlayerMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<WaitingPlayerMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const WaitingPlayerMessage& from);
  void MergeFrom(const WaitingPlayerMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(WaitingPlayerMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "WaitingPlayerMessage";
  }
  protected:
  explicit WaitingPlayerMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 waiting_player_count() const;
  void set_waiting_player_count(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_waiting_player_count() const;
...
class StartMatchMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:StartMatchMessage) */ {
 public:
  inline StartMatchMessage() : StartMatchMessage(nullptr) {};
  virtual ~StartMatchMessage();

  StartMatchMessage(const StartMatchMessage& from);
  StartMatchMessage(StartMatchMessage&& from) noexcept
    : StartMatchMessage() {
    *this = ::std::move(from);
  }

  inline StartMatchMessage& operator=(const StartMatchMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline StartMatchMessage& operator=(StartMatchMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const StartMatchMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const StartMatchMessage* internal_default_instance() {
    return reinterpret_cast<const StartMatchMessage*>(
               &_StartMatchMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    4;

  friend void swap(StartMatchMessage& a, StartMatchMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(StartMatchMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(StartMatchMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline StartMatchMessage* New() const final {
    return CreateMaybeMessage<StartMatchMessage>(nullptr);
  }

  StartMatchMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<StartMatchMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const StartMatchMessage& from);
  void MergeFrom(const StartMatchMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(StartMatchMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "StartMatchMessage";
  }
  protected:
  explicit StartMatchMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    ...
    kMaxPlayersInRoomFieldNumber = 2,
  };
  ...
  const ::PlayerBasicInfo& player_info() const;
  ::PlayerBasicInfo* release_player_info();
  ::PlayerBasicInfo* mutable_player_info();
  void set_allocated_player_info(::PlayerBasicInfo* player_info);
  private:
  const ::PlayerBasicInfo& _internal_player_info() const;
  ::PlayerBasicInfo* _internal_mutable_player_info();
  public:
  void unsafe_arena_set_allocated_player_info(
      ::PlayerBasicInfo* player_info);
  ::PlayerBasicInfo* unsafe_arena_release_player_info();

  // int32 max_players_in_room = 2;
  void clear_max_players_in_room();
  ::PROTOBUF_NAMESPACE_ID::int32 max_players_in_room() const;
  void set_max_players_in_room(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_max_players_in_room() const;
  void _internal_set_max_players_in_room(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // @@protoc_insertion_point(class_scope:StartMatchMessage)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PlayerBasicInfo* player_info_;
  ::PROTOBUF_NAMESPACE_ID::int32 max_players_in_room_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2fproto_2fNetworkMessage_2eproto;
};
// -------------------------------------------------------------------
...
class DataLoadedMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:DataLoadedMessage) */ {
 public:
  inline DataLoadedMessage() : DataLoadedMessage(nullptr) {};
  virtual ~DataLoadedMessage();

  DataLoadedMessage(const DataLoadedMessage& from);
  DataLoadedMessage(DataLoadedMessage&& from) noexcept
    : DataLoadedMessage() {
    *this = ::std::move(from);
  }

  inline DataLoadedMessage& operator=(const DataLoadedMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline DataLoadedMessage& operator=(DataLoadedMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const DataLoadedMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const DataLoadedMessage* internal_default_instance() {
    return reinterpret_cast<const DataLoadedMessage*>(
               &_DataLoadedMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(DataLoadedMessage& a, DataLoadedMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(DataLoadedMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(DataLoadedMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline DataLoadedMessage* New() const final {
    return CreateMaybeMessage<DataLoadedMessage>(nullptr);
  }

  DataLoadedMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<DataLoadedMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const DataLoadedMessage& from);
  void MergeFrom(const DataLoadedMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(DataLoadedMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "DataLoadedMessage";
  }
  protected:
  explicit DataLoadedMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:DataLoadedMessage)
 private:
  class _Internal;
...
class EnemyInfoMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:EnemyInfoMessage) */ {
 public:
  inline EnemyInfoMessage() : EnemyInfoMessage(nullptr) {};
  virtual ~EnemyInfoMessage();

  EnemyInfoMessage(const EnemyInfoMessage& from);
  EnemyInfoMessage(EnemyInfoMessage&& from) noexcept
    : EnemyInfoMessage() {
    *this = ::std::move(from);
  }

  inline EnemyInfoMessage& operator=(const EnemyInfoMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline EnemyInfoMessage& operator=(EnemyInfoMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const EnemyInfoMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const EnemyInfoMessage* internal_default_instance() {
    return reinterpret_cast<const EnemyInfoMessage*>(
               &_EnemyInfoMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    7;

  friend void swap(EnemyInfoMessage& a, EnemyInfoMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(EnemyInfoMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(EnemyInfoMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline EnemyInfoMessage* New() const final {
    return CreateMaybeMessage<EnemyInfoMessage>(nullptr);
  }

  EnemyInfoMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<EnemyInfoMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const EnemyInfoMessage& from);
  void MergeFrom(const EnemyInfoMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(EnemyInfoMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "EnemyInfoMessage";
  }
  protected:
  explicit EnemyInfoMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  const std::string& first_player() const;
  void set_first_player(const std::string& value);
  void set_first_player(std::string&& value);
  void set_first_player(const char* value);
  void set_first_player(const char* value, size_t size);
  std::string* mutable_first_player();
  std::string* release_first_player();
  void set_allocated_first_player(std::string* first_player);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_first_player();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_first_player(
      std::string* first_player);
  private:
  const std::string& _internal_first_player() const;
  void _internal_set_first_player(const std::string& value);
...
class CurrentRankInfoMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:CurrentRankInfoMessage) */ {
 public:
  inline CurrentRankInfoMessage() : CurrentRankInfoMessage(nullptr) {};
  virtual ~CurrentRankInfoMessage();

  CurrentRankInfoMessage(const CurrentRankInfoMessage& from);
  CurrentRankInfoMessage(CurrentRankInfoMessage&& from) noexcept
    : CurrentRankInfoMessage() {
    *this = ::std::move(from);
  }

  inline CurrentRankInfoMessage& operator=(const CurrentRankInfoMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline CurrentRankInfoMessage& operator=(CurrentRankInfoMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const CurrentRankInfoMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const CurrentRankInfoMessage* internal_default_instance() {
    return reinterpret_cast<const CurrentRankInfoMessage*>(
               &_CurrentRankInfoMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    9;

  friend void swap(CurrentRankInfoMessage& a, CurrentRankInfoMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(CurrentRankInfoMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(CurrentRankInfoMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline CurrentRankInfoMessage* New() const final {
    return CreateMaybeMessage<CurrentRankInfoMessage>(nullptr);
  }

  CurrentRankInfoMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<CurrentRankInfoMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const CurrentRankInfoMessage& from);
  void MergeFrom(const CurrentRankInfoMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(CurrentRankInfoMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "CurrentRankInfoMessage";
  }
  protected:
  explicit CurrentRankInfoMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:CurrentRankInfoMessage)
 private:
  class _Internal;
...
class BattlePrepStartMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:BattlePrepStartMessage) */ {
 public:
  inline BattlePrepStartMessage() : BattlePrepStartMessage(nullptr) {};
  virtual ~BattlePrepStartMessage();

  BattlePrepStartMessage(const BattlePrepStartMessage& from);
  BattlePrepStartMessage(BattlePrepStartMessage&& from) noexcept
    : BattlePrepStartMessage() {
    *this = ::std::move(from);
  }

  inline BattlePrepStartMessage& operator=(const BattlePrepStartMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline BattlePrepStartMessage& operator=(BattlePrepStartMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const BattlePrepStartMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const BattlePrepStartMessage* internal_default_instance() {
    return reinterpret_cast<const BattlePrepStartMessage*>(
               &_BattlePrepStartMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(BattlePrepStartMessage& a, BattlePrepStartMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(BattlePrepStartMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(BattlePrepStartMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline BattlePrepStartMessage* New() const final {
    return CreateMaybeMessage<BattlePrepStartMessage>(nullptr);
  }

  BattlePrepStartMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<BattlePrepStartMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const BattlePrepStartMessage& from);
  void MergeFrom(const BattlePrepStartMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(BattlePrepStartMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "BattlePrepStartMessage";
  }
  protected:
  explicit BattlePrepStartMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kFirstPlayerIdFieldNumber = 2,
    kPrepareTimeSecondsFieldNumber = 1,
  };
  ...
  void clear_prepare_time_seconds();
  ::PROTOBUF_NAMESPACE_ID::int32 prepare_time_seconds() const;
  void set_prepare_time_seconds(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_prepare_time_seconds() const;
  void _internal_set_prepare_time_seconds(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // @@protoc_insertion_point(class_scope:BattlePrepStartMessage)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::int32 prepare_time_seconds_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2fproto_2fNetworkMessage_2eproto;
};
// -------------------------------------------------------------------
...
class ExitPlayerInfo PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ExitPlayerInfo) */ {
 public:
  inline ExitPlayerInfo() : ExitPlayerInfo(nullptr) {};
  virtual ~ExitPlayerInfo();

  ExitPlayerInfo(const ExitPlayerInfo& from);
  ExitPlayerInfo(ExitPlayerInfo&& from) noexcept
    : ExitPlayerInfo() {
    *this = ::std::move(from);
  }

  inline ExitPlayerInfo& operator=(const ExitPlayerInfo& from) {
    CopyFrom(from);
    return *this;
  }
  inline ExitPlayerInfo& operator=(ExitPlayerInfo&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ExitPlayerInfo& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ExitPlayerInfo* internal_default_instance() {
    return reinterpret_cast<const ExitPlayerInfo*>(
               &_ExitPlayerInfo_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    17;

  friend void swap(ExitPlayerInfo& a, ExitPlayerInfo& b) {
    a.Swap(&b);
  }
  inline void Swap(ExitPlayerInfo* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ExitPlayerInfo* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline ExitPlayerInfo* New() const final {
    return CreateMaybeMessage<ExitPlayerInfo>(nullptr);
  }

  ExitPlayerInfo* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ExitPlayerInfo>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ExitPlayerInfo& from);
  void MergeFrom(const ExitPlayerInfo& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ExitPlayerInfo* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ExitPlayerInfo";
  }
  protected:
  explicit ExitPlayerInfo(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kExitPlayerIdFieldNumber = 1,
    kExitRoundFieldNumber = 2,
    kExitHonorValueFieldNumber = 3,
  };
  // string exit_player_id = 1;
  void clear_exit_player_id();
  const std::string& exit_player_id() const;
  void set_exit_player_id(const std::string& value);
  void set_exit_player_id(std::string&& value);
  void set_exit_player_id(const char* value);
  void set_exit_player_id(const char* value, size_t size);
  std::string* mutable_exit_player_id();
  std::string* release_exit_player_id();
  void set_allocated_exit_player_id(std::string* exit_player_id);
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  std::string* unsafe_arena_release_exit_player_id();
  GOOGLE_PROTOBUF_RUNTIME_DEPRECATED("The unsafe_arena_ accessors for"
  "    string fields are deprecated and will be removed in a"
  "    future release.")
  void unsafe_arena_set_allocated_exit_player_id(
      std::string* exit_player_id);
  private:
  const std::string& _internal_exit_player_id() const;
  void _internal_set_exit_player_id(const std::string& value);
  std::string* _internal_mutable_exit_player_id();
  public:

  // int32 exit_round = 2;
  void clear_exit_round();
  ::PROTOBUF_NAMESPACE_ID::int32 exit_round() const;
  void set_exit_round(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_exit_round() const;
  void _internal_set_exit_round(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // int32 exit_honor_value = 3;
  void clear_exit_honor_value();
  ::PROTOBUF_NAMESPACE_ID::int32 exit_honor_value() const;
  void set_exit_honor_value(::PROTOBUF_NAMESPACE_ID::int32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::int32 _internal_exit_honor_value() const;
  void _internal_set_exit_honor_value(::PROTOBUF_NAMESPACE_ID::int32 value);
  public:

  // @@protoc_insertion_point(class_scope:ExitPlayerInfo)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr exit_player_id_;
  ::PROTOBUF_NAMESPACE_ID::int32 exit_round_;
  ::PROTOBUF_NAMESPACE_ID::int32 exit_honor_value_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2fproto_2fNetworkMessage_2eproto;
};
// -------------------------------------------------------------------

class ExitMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ExitMessage) */ {
 public:
  ...
  inline void Swap(ExitMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ExitMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  protected:
  explicit ExitMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kExitInfoFieldNumber = 1,
  };
  // .ExitPlayerInfo exit_info = 1;
  bool has_exit_info() const;
  private:
  bool _internal_has_exit_info() const;
  public:
  void clear_exit_info();
  const ::ExitPlayerInfo& exit_info() const;
  ::ExitPlayerInfo* release_exit_info();
  ::ExitPlayerInfo* mutable_exit_info();
  void set_allocated_exit_info(::ExitPlayerInfo* exit_info);
  private:
  const ::ExitPlayerInfo& _internal_exit_info() const;
  ::ExitPlayerInfo* _internal_mutable_exit_info();
  public:
  void unsafe_arena_set_allocated_exit_info(
      ::ExitPlayerInfo* exit_info);
  ::ExitPlayerInfo* unsafe_arena_release_exit_info();

  // @@protoc_insertion_point(class_scope:ExitMessage)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::ExitPlayerInfo* exit_info_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2fproto_2fNetworkMessage_2eproto;
};
// -------------------------------------------------------------------

class ExitBroadcastMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:ExitBroadcastMessage) */ {
 public:
  inline ExitBroadcastMessage() : ExitBroadcastMessage(nullptr) {};
  virtual ~ExitBroadcastMessage();

  ExitBroadcastMessage(const ExitBroadcastMessage& from);
  ExitBroadcastMessage(ExitBroadcastMessage&& from) noexcept
    : ExitBroadcastMessage() {
    *this = ::std::move(from);
  }

  inline ExitBroadcastMessage& operator=(const ExitBroadcastMessage& from) {
    CopyFrom(from);
    return *this;
  }
  inline ExitBroadcastMessage& operator=(ExitBroadcastMessage&& from) noexcept {
    if (GetArena() == from.GetArena()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const ExitBroadcastMessage& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const ExitBroadcastMessage* internal_default_instance() {
    return reinterpret_cast<const ExitBroadcastMessage*>(
               &_ExitBroadcastMessage_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    19;

  friend void swap(ExitBroadcastMessage& a, ExitBroadcastMessage& b) {
    a.Swap(&b);
  }
  inline void Swap(ExitBroadcastMessage* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(ExitBroadcastMessage* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline ExitBroadcastMessage* New() const final {
    return CreateMaybeMessage<ExitBroadcastMessage>(nullptr);
  }

  ExitBroadcastMessage* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<ExitBroadcastMessage>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const ExitBroadcastMessage& from);
  void MergeFrom(const ExitBroadcastMessage& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ExitBroadcastMessage* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "ExitBroadcastMessage";
  }
  protected:
  explicit ExitBroadcastMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  enum : int {
    kExitPlayersInfoFieldNumber = 1,
  };
  // repeated .ExitPlayerInfo exit_players_info = 1;
  int exit_players_info_size() const;
  private:
  int _internal_exit_players_info_size() const;
  public:
  void clear_exit_players_info();
  ::ExitPlayerInfo* mutable_exit_players_info(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ExitPlayerInfo >*
      mutable_exit_players_info();
  private:
  const ::ExitPlayerInfo& _internal_exit_players_info(int index) const;
  ::ExitPlayerInfo* _internal_add_exit_players_info();
  public:
  const ::ExitPlayerInfo& exit_players_info(int index) const;
  ::ExitPlayerInfo* add_exit_players_info();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ExitPlayerInfo >&
      exit_players_info() const;

  // @@protoc_insertion_point(class_scope:ExitBroadcastMessage)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ExitPlayerInfo > exit_players_info_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_src_2fproto_2fNetworkMessage_2eproto;
};
// -------------------------------------------------------------------
...
class NetworkMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  enum DataCase {
    ...
    kBattlePrepStart = 13,
    kBattlePrepTimer = 14,
    kBattlePrepSnapshot = 15,
    kAllSnapshots = 16,
    kBattleResultReport = 17,
    kSettlement = 18,
    kExit = 19,
    kExitBroadcast = 20,
    DATA_NOT_SET = 0,
  ...
  enum : int {
    ...
    kStartMatchFieldNumber = 7,
    kWaitingPlayerFieldNumber = 8,
    kGameStartFieldNumber = 9,
    kDataLoadedFieldNumber = 10,
    kEnemyInfoFieldNumber = 11,
    kCurrentRankInfoFieldNumber = 12,
    kBattlePrepStartFieldNumber = 13,
    kBattlePrepTimerFieldNumber = 14,
    kBattlePrepSnapshotFieldNumber = 15,
    kAllSnapshotsFieldNumber = 16,
    kBattleResultReportFieldNumber = 17,
    kSettlementFieldNumber = 18,
    kExitFieldNumber = 19,
    kExitBroadcastFieldNumber = 20,
  };
  // string player_id = 2;
  void clear_player_id();
  const std::string& player_id() const;
  ...
  bool has_start_match() const;
  private:
  bool _internal_has_start_match() const;
  public:
  void clear_start_match();
  const ::StartMatchMessage& start_match() const;
  ::StartMatchMessage* release_start_match();
  ::StartMatchMessage* mutable_start_match();
  void set_allocated_start_match(::StartMatchMessage* start_match);
  private:
  const ::StartMatchMessage& _internal_start_match() const;
  ::StartMatchMessage* _internal_mutable_start_match();
  public:
  void unsafe_arena_set_allocated_start_match(
      ::StartMatchMessage* start_match);
  ::StartMatchMessage* unsafe_arena_release_start_match();

  // .WaitingPlayerMessage waiting_player = 8;
  bool has_waiting_player() const;
  private:
  bool _internal_has_waiting_player() const;
  public:
  void clear_waiting_player();
  const ::WaitingPlayerMessage& waiting_player() const;
  ::WaitingPlayerMessage* release_waiting_player();
  ::WaitingPlayerMessage* mutable_waiting_player();
  void set_allocated_waiting_player(::WaitingPlayerMessage* waiting_player);
  private:
  const ::WaitingPlayerMessage& _internal_waiting_player() const;
  ::WaitingPlayerMessage* _internal_mutable_waiting_player();
  public:
  void unsafe_arena_set_allocated_waiting_player(
      ::WaitingPlayerMessage* waiting_player);
  ::WaitingPlayerMessage* unsafe_arena_release_waiting_player();
  ...
  private:
  bool _internal_has_data_loaded() const;
  public:
  void clear_data_loaded();
  const ::DataLoadedMessage& data_loaded() const;
  ::DataLoadedMessage* release_data_loaded();
  ::DataLoadedMessage* mutable_data_loaded();
  void set_allocated_data_loaded(::DataLoadedMessage* data_loaded);
  private:
  const ::DataLoadedMessage& _internal_data_loaded() const;
  ::DataLoadedMessage* _internal_mutable_data_loaded();
  public:
  void unsafe_arena_set_allocated_data_loaded(
      ::DataLoadedMessage* data_loaded);
  ::DataLoadedMessage* unsafe_arena_release_data_loaded();

  // .EnemyInfoMessage enemy_info = 11;
  bool has_enemy_info() const;
  private:
  bool _internal_has_enemy_info() const;
  public:
  void clear_enemy_info();
  const ::EnemyInfoMessage& enemy_info() const;
  ::EnemyInfoMessage* release_enemy_info();
  ::EnemyInfoMessage* mutable_enemy_info();
  void set_allocated_enemy_info(::EnemyInfoMessage* enemy_info);
  private:
  const ::EnemyInfoMessage& _internal_enemy_info() const;
  ::EnemyInfoMessage* _internal_mutable_enemy_info();
  public:
  void unsafe_arena_set_allocated_enemy_info(
      ::EnemyInfoMessage* enemy_info);
  ::EnemyInfoMessage* unsafe_arena_release_enemy_info();

  // .CurrentRankInfoMessage current_rank_info = 12;
  bool has_current_rank_info() const;
  private:
  bool _internal_has_current_rank_info() const;
  public:
  void clear_current_rank_info();
  const ::CurrentRankInfoMessage& current_rank_info() const;
  ::CurrentRankInfoMessage* release_current_rank_info();
  ::CurrentRankInfoMessage* mutable_current_rank_info();
  void set_allocated_current_rank_info(::CurrentRankInfoMessage* current_rank_info);
  private:
  const ::CurrentRankInfoMessage& _internal_current_rank_info() const;
  ::CurrentRankInfoMessage* _internal_mutable_current_rank_info();
  public:
  void unsafe_arena_set_allocated_current_rank_info(
      ::CurrentRankInfoMessage* current_rank_info);
  ::CurrentRankInfoMessage* unsafe_arena_release_current_rank_info();

  // .BattlePrepStartMessage battle_prep_start = 13;
  bool has_battle_prep_start() const;
  private:
  bool _internal_has_battle_prep_start() const;
  public:
  void clear_battle_prep_start();
  const ::BattlePrepStartMessage& battle_prep_start() const;
  ::BattlePrepStartMessage* release_battle_prep_start();
  ::BattlePrepStartMessage* mutable_battle_prep_start();
  void set_allocated_battle_prep_start(::BattlePrepStartMessage* battle_prep_start);
  private:
  const ::BattlePrepStartMessage& _internal_battle_prep_start() const;
  ::BattlePrepStartMessage* _internal_mutable_battle_prep_start();
  public:
  void unsafe_arena_set_allocated_battle_prep_start(
      ::BattlePrepStartMessage* battle_prep_start);
  ::BattlePrepStartMessage* unsafe_arena_release_battle_prep_start();
  ...
  public:
  void clear_exit();
  const ::ExitMessage& exit() const;
  ::ExitMessage* release_exit();
  ::ExitMessage* mutable_exit();
  void set_allocated_exit(::ExitMessage* exit);
  private:
  const ::ExitMessage& _internal_exit() const;
  ::ExitMessage* _internal_mutable_exit();
  public:
  void unsafe_arena_set_allocated_exit(
      ::ExitMessage* exit);
  ::ExitMessage* unsafe_arena_release_exit();

  // .ExitBroadcastMessage exit_broadcast = 20;
  bool has_exit_broadcast() const;
  private:
  bool _internal_has_exit_broadcast() const;
  public:
  void clear_exit_broadcast();
  const ::ExitBroadcastMessage& exit_broadcast() const;
  ::ExitBroadcastMessage* release_exit_broadcast();
  ::ExitBroadcastMessage* mutable_exit_broadcast();
  void set_allocated_exit_broadcast(::ExitBroadcastMessage* exit_broadcast);
  private:
  const ::ExitBroadcastMessage& _internal_exit_broadcast() const;
  ::ExitBroadcastMessage* _internal_mutable_exit_broadcast();
  public:
  void unsafe_arena_set_allocated_exit_broadcast(
      ::ExitBroadcastMessage* exit_broadcast);
  ::ExitBroadcastMessage* unsafe_arena_release_exit_broadcast();
 ...
 private:
  ...
  void set_has_start_match();
  void set_has_waiting_player();
  void set_has_game_start();
  void set_has_data_loaded();
  void set_has_enemy_info();
  void set_has_current_rank_info();
  void set_has_battle_prep_start();
  ...
  union DataUnion {
    ...
    ::StartMatchMessage* start_match_;
    ::WaitingPlayerMessage* waiting_player_;
    ::GameStartMessage* game_start_;
    ::DataLoadedMessage* data_loaded_;
    ::EnemyInfoMessage* enemy_info_;
    ::CurrentRankInfoMessage* current_rank_info_;
    ::BattlePrepStartMessage* battle_prep_start_;
    ...
    ::ExitMessage* exit_;
    ::ExitBroadcastMessage* exit_broadcast_;
  } data_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
...
// int32 waiting_player_count = 1;
inline void WaitingPlayerMessage::clear_waiting_player_count() {
  waiting_player_count_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WaitingPlayerMessage::_internal_waiting_player_count() const {
  return waiting_player_count_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 WaitingPlayerMessage::waiting_player_count() const {
  // @@protoc_insertion_point(field_get:WaitingPlayerMessage.waiting_player_count)
  return _internal_waiting_player_count();
}
inline void WaitingPlayerMessage::_internal_set_waiting_player_count(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  waiting_player_count_ = value;
}
...
// .PlayerBasicInfo player_info = 1;
inline bool StartMatchMessage::_internal_has_player_info() const {
  return this != internal_default_instance() && player_info_ != nullptr;
}
inline bool StartMatchMessage::has_player_info() const {
  return _internal_has_player_info();
}
inline void StartMatchMessage::clear_player_info() {
  if (GetArena() == nullptr && player_info_ != nullptr) {
    delete player_info_;
  }
  player_info_ = nullptr;
}
inline const ::PlayerBasicInfo& StartMatchMessage::_internal_player_info() const {
  const ::PlayerBasicInfo* p = player_info_;
  return p != nullptr ? *p : *reinterpret_cast<const ::PlayerBasicInfo*>(
      &::_PlayerBasicInfo_default_instance_);
}
inline const ::PlayerBasicInfo& StartMatchMessage::player_info() const {
  // @@protoc_insertion_point(field_get:StartMatchMessage.player_info)
  return _internal_player_info();
}
inline void StartMatchMessage::unsafe_arena_set_allocated_player_info(
    ::PlayerBasicInfo* player_info) {
  if (GetArena() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:StartMatchMessage.player_info)
}
inline ::PlayerBasicInfo* StartMatchMessage::release_player_info() {
...
inline ::PlayerBasicInfo* StartMatchMessage::unsafe_arena_release_player_info() {
  // @@protoc_insertion_point(field_release:StartMatchMessage.player_info)
  
  ::PlayerBasicInfo* temp = player_info_;
  player_info_ = nullptr;
  return temp;
}
inline ::PlayerBasicInfo* StartMatchMessage::_internal_mutable_player_info() {
  
  if (player_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::PlayerBasicInfo>(GetArena());
    player_info_ = p;
  }
  return player_info_;
}
inline ::PlayerBasicInfo* StartMatchMessage::mutable_player_info() {
  // @@protoc_insertion_point(field_mutable:StartMatchMessage.player_info)
  return _internal_mutable_player_info();
}
inline void StartMatchMessage::set_allocated_player_info(::PlayerBasicInfo* player_info) {
  ...
  player_info_ = player_info;
  // @@protoc_insertion_point(field_set_allocated:StartMatchMessage.player_info)
}

// int32 max_players_in_room = 2;
inline void StartMatchMessage::clear_max_players_in_room() {
  max_players_in_room_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 StartMatchMessage::_internal_max_players_in_room() const {
  return max_players_in_room_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 StartMatchMessage::max_players_in_room() const {
  // @@protoc_insertion_point(field_get:StartMatchMessage.max_players_in_room)
  return _internal_max_players_in_room();
}
inline void StartMatchMessage::_internal_set_max_players_in_room(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  max_players_in_room_ = value;
}
inline void StartMatchMessage::set_max_players_in_room(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_max_players_in_room(value);
  // @@protoc_insertion_point(field_set:StartMatchMessage.max_players_in_room)
}
...
// string enemy_player_id = 1;
inline void EnemyInfoMessage::clear_enemy_player_id() {
  enemy_player_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& EnemyInfoMessage::enemy_player_id() const {
  // @@protoc_insertion_point(field_get:EnemyInfoMessage.enemy_player_id)
  return _internal_enemy_player_id();
}
inline void EnemyInfoMessage::set_enemy_player_id(const std::string& value) {
  _internal_set_enemy_player_id(value);
  // @@protoc_insertion_point(field_set:EnemyInfoMessage.enemy_player_id)
}
inline std::string* EnemyInfoMessage::mutable_enemy_player_id() {
  // @@protoc_insertion_point(field_mutable:EnemyInfoMessage.enemy_player_id)
  return _internal_mutable_enemy_player_id();
}
inline const std::string& EnemyInfoMessage::_internal_enemy_player_id() const {
  return enemy_player_id_.Get();
}
inline void EnemyInfoMessage::_internal_set_enemy_player_id(const std::string& value) {
  
  enemy_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void EnemyInfoMessage::set_enemy_player_id(std::string&& value) {
  
  enemy_player_id_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:EnemyInfoMessage.enemy_player_id)
}
inline void EnemyInfoMessage::set_enemy_player_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  enemy_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:EnemyInfoMessage.enemy_player_id)
}
inline void EnemyInfoMessage::set_enemy_player_id(const char* value,
    size_t size) {
  ...
  enemy_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:EnemyInfoMessage.enemy_player_id)
}
inline std::string* EnemyInfoMessage::_internal_mutable_enemy_player_id() {
  
  return enemy_player_id_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* EnemyInfoMessage::release_enemy_player_id() {
  // @@protoc_insertion_point(field_release:EnemyInfoMessage.enemy_player_id)
  return enemy_player_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void EnemyInfoMessage::set_allocated_enemy_player_id(std::string* enemy_player_id) {
  ...
  enemy_player_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), enemy_player_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:EnemyInfoMessage.enemy_player_id)
}
inline std::string* EnemyInfoMessage::unsafe_arena_release_enemy_player_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:EnemyInfoMessage.enemy_player_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return enemy_player_id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void EnemyInfoMessage::unsafe_arena_set_allocated_enemy_player_id(
    std::string* enemy_player_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (enemy_player_id != nullptr) {
...
// string first_player = 4;
inline void EnemyInfoMessage::clear_first_player() {
  first_player_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& EnemyInfoMessage::first_player() const {
  // @@protoc_insertion_point(field_get:EnemyInfoMessage.first_player)
  return _internal_first_player();
}
inline void EnemyInfoMessage::set_first_player(const std::string& value) {
  _internal_set_first_player(value);
  // @@protoc_insertion_point(field_set:EnemyInfoMessage.first_player)
}
inline std::string* EnemyInfoMessage::mutable_first_player() {
  // @@protoc_insertion_point(field_mutable:EnemyInfoMessage.first_player)
  return _internal_mutable_first_player();
}
inline const std::string& EnemyInfoMessage::_internal_first_player() const {
  return first_player_.Get();
}
inline void EnemyInfoMessage::_internal_set_first_player(const std::string& value) {
  
  first_player_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void EnemyInfoMessage::set_first_player(std::string&& value) {
  
  first_player_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:EnemyInfoMessage.first_player)
}
inline void EnemyInfoMessage::set_first_player(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  first_player_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:EnemyInfoMessage.first_player)
}
inline void EnemyInfoMessage::set_first_player(const char* value,
    size_t size) {
  
  first_player_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:EnemyInfoMessage.first_player)
}
inline std::string* EnemyInfoMessage::_internal_mutable_first_player() {
  
  return first_player_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* EnemyInfoMessage::release_first_player() {
  // @@protoc_insertion_point(field_release:EnemyInfoMessage.first_player)
  return first_player_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void EnemyInfoMessage::set_allocated_first_player(std::string* first_player) {
  if (first_player != nullptr) {
    
  } else {
    
  }
  first_player_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), first_player,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:EnemyInfoMessage.first_player)
}
inline std::string* EnemyInfoMessage::unsafe_arena_release_first_player() {
  // @@protoc_insertion_point(field_unsafe_arena_release:EnemyInfoMessage.first_player)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return first_player_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void EnemyInfoMessage::unsafe_arena_set_allocated_first_player(
    std::string* first_player) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (first_player != nullptr) {
  ...
  first_player_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      first_player, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:EnemyInfoMessage.first_player)
}
...
// repeated .RankingEntry rankings = 1;
inline int CurrentRankInfoMessage::_internal_rankings_size() const {
  return rankings_.size();
}
inline int CurrentRankInfoMessage::rankings_size() const {
  return _internal_rankings_size();
}
inline void CurrentRankInfoMessage::clear_rankings() {
  rankings_.Clear();
}
inline ::RankingEntry* CurrentRankInfoMessage::mutable_rankings(int index) {
  // @@protoc_insertion_point(field_mutable:CurrentRankInfoMessage.rankings)
  return rankings_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::RankingEntry >*
CurrentRankInfoMessage::mutable_rankings() {
  // @@protoc_insertion_point(field_mutable_list:CurrentRankInfoMessage.rankings)
  return &rankings_;
}
inline const ::RankingEntry& CurrentRankInfoMessage::_internal_rankings(int index) const {
  return rankings_.Get(index);
}
inline const ::RankingEntry& CurrentRankInfoMessage::rankings(int index) const {
  // @@protoc_insertion_point(field_get:CurrentRankInfoMessage.rankings)
  return _internal_rankings(index);
}
inline ::RankingEntry* CurrentRankInfoMessage::_internal_add_rankings() {
  return rankings_.Add();
}
inline ::RankingEntry* CurrentRankInfoMessage::add_rankings() {
  // @@protoc_insertion_point(field_add:CurrentRankInfoMessage.rankings)
  return _internal_add_rankings();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::RankingEntry >&
CurrentRankInfoMessage::rankings() const {
  // @@protoc_insertion_point(field_list:CurrentRankInfoMessage.rankings)
  return rankings_;
}
...
// int32 prepare_time_seconds = 1;
inline void BattlePrepStartMessage::clear_prepare_time_seconds() {
  prepare_time_seconds_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BattlePrepStartMessage::_internal_prepare_time_seconds() const {
  return prepare_time_seconds_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 BattlePrepStartMessage::prepare_time_seconds() const {
  // @@protoc_insertion_point(field_get:BattlePrepStartMessage.prepare_time_seconds)
  return _internal_prepare_time_seconds();
}
inline void BattlePrepStartMessage::_internal_set_prepare_time_seconds(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  prepare_time_seconds_ = value;
}
inline void BattlePrepStartMessage::set_prepare_time_seconds(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_prepare_time_seconds(value);
  // @@protoc_insertion_point(field_set:BattlePrepStartMessage.prepare_time_seconds)
}

// string first_player_id = 2;
inline void BattlePrepStartMessage::clear_first_player_id() {
  first_player_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& BattlePrepStartMessage::first_player_id() const {
  // @@protoc_insertion_point(field_get:BattlePrepStartMessage.first_player_id)
  return _internal_first_player_id();
}
inline void BattlePrepStartMessage::set_first_player_id(const std::string& value) {
  _internal_set_first_player_id(value);
  // @@protoc_insertion_point(field_set:BattlePrepStartMessage.first_player_id)
}
inline std::string* BattlePrepStartMessage::mutable_first_player_id() {
  // @@protoc_insertion_point(field_mutable:BattlePrepStartMessage.first_player_id)
  return _internal_mutable_first_player_id();
}
inline const std::string& BattlePrepStartMessage::_internal_first_player_id() const {
  return first_player_id_.Get();
}
inline void BattlePrepStartMessage::_internal_set_first_player_id(const std::string& value) {
  
  first_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void BattlePrepStartMessage::set_first_player_id(std::string&& value) {
  
  first_player_id_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:BattlePrepStartMessage.first_player_id)
}
inline void BattlePrepStartMessage::set_first_player_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  first_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:BattlePrepStartMessage.first_player_id)
}
inline void BattlePrepStartMessage::set_first_player_id(const char* value,
    size_t size) {
  ...
  first_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:BattlePrepStartMessage.first_player_id)
}
inline std::string* BattlePrepStartMessage::_internal_mutable_first_player_id() {
  
  return first_player_id_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* BattlePrepStartMessage::release_first_player_id() {
  // @@protoc_insertion_point(field_release:BattlePrepStartMessage.first_player_id)
  return first_player_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void BattlePrepStartMessage::set_allocated_first_player_id(std::string* first_player_id) {
  ...
  first_player_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), first_player_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:BattlePrepStartMessage.first_player_id)
}
inline std::string* BattlePrepStartMessage::unsafe_arena_release_first_player_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:BattlePrepStartMessage.first_player_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return first_player_id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void BattlePrepStartMessage::unsafe_arena_set_allocated_first_player_id(
    std::string* first_player_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (first_player_id != nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:BattlePrepStartMessage.first_player_id)
}
...
// string exit_player_id = 1;
inline void ExitPlayerInfo::clear_exit_player_id() {
  exit_player_id_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline const std::string& ExitPlayerInfo::exit_player_id() const {
  // @@protoc_insertion_point(field_get:ExitPlayerInfo.exit_player_id)
  return _internal_exit_player_id();
}
inline void ExitPlayerInfo::set_exit_player_id(const std::string& value) {
  _internal_set_exit_player_id(value);
  // @@protoc_insertion_point(field_set:ExitPlayerInfo.exit_player_id)
}
inline std::string* ExitPlayerInfo::mutable_exit_player_id() {
  // @@protoc_insertion_point(field_mutable:ExitPlayerInfo.exit_player_id)
  return _internal_mutable_exit_player_id();
}
inline const std::string& ExitPlayerInfo::_internal_exit_player_id() const {
  return exit_player_id_.Get();
}
inline void ExitPlayerInfo::_internal_set_exit_player_id(const std::string& value) {
  
  exit_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void ExitPlayerInfo::set_exit_player_id(std::string&& value) {
  
  exit_player_id_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:ExitPlayerInfo.exit_player_id)
}
inline void ExitPlayerInfo::set_exit_player_id(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  exit_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:ExitPlayerInfo.exit_player_id)
}
inline void ExitPlayerInfo::set_exit_player_id(const char* value,
    size_t size) {
  
  exit_player_id_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:ExitPlayerInfo.exit_player_id)
}
inline std::string* ExitPlayerInfo::_internal_mutable_exit_player_id() {
  
  return exit_player_id_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* ExitPlayerInfo::release_exit_player_id() {
  // @@protoc_insertion_point(field_release:ExitPlayerInfo.exit_player_id)
  return exit_player_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline void ExitPlayerInfo::set_allocated_exit_player_id(std::string* exit_player_id) {
  if (exit_player_id != nullptr) {
    
  } else {
    
  }
  exit_player_id_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), exit_player_id,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:ExitPlayerInfo.exit_player_id)
}
inline std::string* ExitPlayerInfo::unsafe_arena_release_exit_player_id() {
  // @@protoc_insertion_point(field_unsafe_arena_release:ExitPlayerInfo.exit_player_id)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return exit_player_id_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void ExitPlayerInfo::unsafe_arena_set_allocated_exit_player_id(
    std::string* exit_player_id) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (exit_player_id != nullptr) {
  ...
  exit_player_id_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      exit_player_id, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ExitPlayerInfo.exit_player_id)
}

// int32 exit_round = 2;
inline void ExitPlayerInfo::clear_exit_round() {
  exit_round_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ExitPlayerInfo::_internal_exit_round() const {
  return exit_round_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ExitPlayerInfo::exit_round() const {
  // @@protoc_insertion_point(field_get:ExitPlayerInfo.exit_round)
  return _internal_exit_round();
}
inline void ExitPlayerInfo::_internal_set_exit_round(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  exit_round_ = value;
}
inline void ExitPlayerInfo::set_exit_round(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_exit_round(value);
  // @@protoc_insertion_point(field_set:ExitPlayerInfo.exit_round)
}

// int32 exit_honor_value = 3;
inline void ExitPlayerInfo::clear_exit_honor_value() {
  exit_honor_value_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ExitPlayerInfo::_internal_exit_honor_value() const {
  return exit_honor_value_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ExitPlayerInfo::exit_honor_value() const {
  // @@protoc_insertion_point(field_get:ExitPlayerInfo.exit_honor_value)
  return _internal_exit_honor_value();
}
inline void ExitPlayerInfo::_internal_set_exit_honor_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  exit_honor_value_ = value;
}
inline void ExitPlayerInfo::set_exit_honor_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_exit_honor_value(value);
  // @@protoc_insertion_point(field_set:ExitPlayerInfo.exit_honor_value)
}
...
// .ExitPlayerInfo exit_info = 1;
inline bool ExitMessage::_internal_has_exit_info() const {
  return this != internal_default_instance() && exit_info_ != nullptr;
}
inline bool ExitMessage::has_exit_info() const {
  return _internal_has_exit_info();
}
inline void ExitMessage::clear_exit_info() {
  if (GetArena() == nullptr && exit_info_ != nullptr) {
    delete exit_info_;
  }
  exit_info_ = nullptr;
}
inline const ::ExitPlayerInfo& ExitMessage::_internal_exit_info() const {
  const ::ExitPlayerInfo* p = exit_info_;
  return p != nullptr ? *p : *reinterpret_cast<const ::ExitPlayerInfo*>(
      &::_ExitPlayerInfo_default_instance_);
}
inline const ::ExitPlayerInfo& ExitMessage::exit_info() const {
  // @@protoc_insertion_point(field_get:ExitMessage.exit_info)
  return _internal_exit_info();
}
inline void ExitMessage::unsafe_arena_set_allocated_exit_info(
    ::ExitPlayerInfo* exit_info) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(exit_info_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:ExitMessage.exit_info)
}
inline ::ExitPlayerInfo* ExitMessage::release_exit_info() {
  auto temp = unsafe_arena_release_exit_info();
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
  return temp;
}
inline ::ExitPlayerInfo* ExitMessage::unsafe_arena_release_exit_info() {
  // @@protoc_insertion_point(field_release:ExitMessage.exit_info)
  
  ::ExitPlayerInfo* temp = exit_info_;
  exit_info_ = nullptr;
  return temp;
}
inline ::ExitPlayerInfo* ExitMessage::_internal_mutable_exit_info() {
  
  if (exit_info_ == nullptr) {
    auto* p = CreateMaybeMessage<::ExitPlayerInfo>(GetArena());
    exit_info_ = p;
  }
  return exit_info_;
}
inline ::ExitPlayerInfo* ExitMessage::mutable_exit_info() {
  // @@protoc_insertion_point(field_mutable:ExitMessage.exit_info)
  return _internal_mutable_exit_info();
}
inline void ExitMessage::set_allocated_exit_info(::ExitPlayerInfo* exit_info) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete exit_info_;
  }
  if (exit_info) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(exit_info);
    if (message_arena != submessage_arena) {
      exit_info = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, exit_info, submessage_arena);
    }
  ...
  exit_info_ = exit_info;
  // @@protoc_insertion_point(field_set_allocated:ExitMessage.exit_info)
}
...
// repeated .ExitPlayerInfo exit_players_info = 1;
inline int ExitBroadcastMessage::_internal_exit_players_info_size() const {
  return exit_players_info_.size();
}
inline int ExitBroadcastMessage::exit_players_info_size() const {
  return _internal_exit_players_info_size();
}
inline void ExitBroadcastMessage::clear_exit_players_info() {
  exit_players_info_.Clear();
}
inline ::ExitPlayerInfo* ExitBroadcastMessage::mutable_exit_players_info(int index) {
  // @@protoc_insertion_point(field_mutable:ExitBroadcastMessage.exit_players_info)
  return exit_players_info_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ExitPlayerInfo >*
ExitBroadcastMessage::mutable_exit_players_info() {
  // @@protoc_insertion_point(field_mutable_list:ExitBroadcastMessage.exit_players_info)
  return &exit_players_info_;
}
inline const ::ExitPlayerInfo& ExitBroadcastMessage::_internal_exit_players_info(int index) const {
  return exit_players_info_.Get(index);
}
inline const ::ExitPlayerInfo& ExitBroadcastMessage::exit_players_info(int index) const {
  // @@protoc_insertion_point(field_get:ExitBroadcastMessage.exit_players_info)
  return _internal_exit_players_info(index);
}
inline ::ExitPlayerInfo* ExitBroadcastMessage::_internal_add_exit_players_info() {
  return exit_players_info_.Add();
}
inline ::ExitPlayerInfo* ExitBroadcastMessage::add_exit_players_info() {
  // @@protoc_insertion_point(field_add:ExitBroadcastMessage.exit_players_info)
  return _internal_add_exit_players_info();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::ExitPlayerInfo >&
ExitBroadcastMessage::exit_players_info() const {
  // @@protoc_insertion_point(field_list:ExitBroadcastMessage.exit_players_info)
  return exit_players_info_;
}
...
// .StartMatchMessage start_match = 7;
inline bool NetworkMessage::_internal_has_start_match() const {
  return data_case() == kStartMatch;
}
inline bool NetworkMessage::has_start_match() const {
  return _internal_has_start_match();
}
inline void NetworkMessage::set_has_start_match() {
  _oneof_case_[0] = kStartMatch;
}
inline void NetworkMessage::clear_start_match() {
...
inline ::StartMatchMessage* NetworkMessage::release_start_match() {
  // @@protoc_insertion_point(field_release:NetworkMessage.start_match)
  if (_internal_has_start_match()) {
    clear_has_data();
      ::StartMatchMessage* temp = data_.start_match_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.start_match_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::StartMatchMessage& NetworkMessage::_internal_start_match() const {
  return _internal_has_start_match()
      ? *data_.start_match_
      : *reinterpret_cast< ::StartMatchMessage*>(&::_StartMatchMessage_default_instance_);
}
inline const ::StartMatchMessage& NetworkMessage::start_match() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.start_match)
  return _internal_start_match();
}
inline ::StartMatchMessage* NetworkMessage::unsafe_arena_release_start_match() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.start_match)
  if (_internal_has_start_match()) {
    clear_has_data();
    ::StartMatchMessage* temp = data_.start_match_;
    data_.start_match_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_start_match(::StartMatchMessage* start_match) {
  clear_data();
  if (start_match) {
    set_has_start_match();
    data_.start_match_ = start_match;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.start_match)
}
inline ::StartMatchMessage* NetworkMessage::_internal_mutable_start_match() {
  if (!_internal_has_start_match()) {
    clear_data();
    set_has_start_match();
    data_.start_match_ = CreateMaybeMessage< ::StartMatchMessage >(GetArena());
  }
  return data_.start_match_;
}
inline ::StartMatchMessage* NetworkMessage::mutable_start_match() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.start_match)
  return _internal_mutable_start_match();
}

// .WaitingPlayerMessage waiting_player = 8;
inline bool NetworkMessage::_internal_has_waiting_player() const {
  return data_case() == kWaitingPlayer;
}
inline bool NetworkMessage::has_waiting_player() const {
  return _internal_has_waiting_player();
}
inline void NetworkMessage::set_has_waiting_player() {
  _oneof_case_[0] = kWaitingPlayer;
}
inline void NetworkMessage::clear_waiting_player() {
...
inline ::WaitingPlayerMessage* NetworkMessage::release_waiting_player() {
  // @@protoc_insertion_point(field_release:NetworkMessage.waiting_player)
  if (_internal_has_waiting_player()) {
    clear_has_data();
      ::WaitingPlayerMessage* temp = data_.waiting_player_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.waiting_player_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::WaitingPlayerMessage& NetworkMessage::_internal_waiting_player() const {
  return _internal_has_waiting_player()
      ? *data_.waiting_player_
      : *reinterpret_cast< ::WaitingPlayerMessage*>(&::_WaitingPlayerMessage_default_instance_);
}
inline const ::WaitingPlayerMessage& NetworkMessage::waiting_player() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.waiting_player)
  return _internal_waiting_player();
}
inline ::WaitingPlayerMessage* NetworkMessage::unsafe_arena_release_waiting_player() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.waiting_player)
  if (_internal_has_waiting_player()) {
    clear_has_data();
    ::WaitingPlayerMessage* temp = data_.waiting_player_;
    data_.waiting_player_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_waiting_player(::WaitingPlayerMessage* waiting_player) {
  clear_data();
  if (waiting_player) {
    set_has_waiting_player();
    data_.waiting_player_ = waiting_player;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.waiting_player)
}
inline ::WaitingPlayerMessage* NetworkMessage::_internal_mutable_waiting_player() {
  if (!_internal_has_waiting_player()) {
    clear_data();
    set_has_waiting_player();
    data_.waiting_player_ = CreateMaybeMessage< ::WaitingPlayerMessage >(GetArena());
  }
  return data_.waiting_player_;
}
inline ::WaitingPlayerMessage* NetworkMessage::mutable_waiting_player() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.waiting_player)
  return _internal_mutable_waiting_player();
}
...
// .DataLoadedMessage data_loaded = 10;
inline bool NetworkMessage::_internal_has_data_loaded() const {
  return data_case() == kDataLoaded;
}
inline bool NetworkMessage::has_data_loaded() const {
  return _internal_has_data_loaded();
}
inline void NetworkMessage::set_has_data_loaded() {
  _oneof_case_[0] = kDataLoaded;
}
inline void NetworkMessage::clear_data_loaded() {
...
inline ::DataLoadedMessage* NetworkMessage::release_data_loaded() {
  // @@protoc_insertion_point(field_release:NetworkMessage.data_loaded)
  if (_internal_has_data_loaded()) {
    clear_has_data();
      ::DataLoadedMessage* temp = data_.data_loaded_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.data_loaded_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::DataLoadedMessage& NetworkMessage::_internal_data_loaded() const {
  return _internal_has_data_loaded()
      ? *data_.data_loaded_
      : *reinterpret_cast< ::DataLoadedMessage*>(&::_DataLoadedMessage_default_instance_);
}
inline const ::DataLoadedMessage& NetworkMessage::data_loaded() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.data_loaded)
  return _internal_data_loaded();
}
inline ::DataLoadedMessage* NetworkMessage::unsafe_arena_release_data_loaded() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.data_loaded)
  if (_internal_has_data_loaded()) {
    clear_has_data();
    ::DataLoadedMessage* temp = data_.data_loaded_;
    data_.data_loaded_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_data_loaded(::DataLoadedMessage* data_loaded) {
  clear_data();
  if (data_loaded) {
    set_has_data_loaded();
    data_.data_loaded_ = data_loaded;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.data_loaded)
}
inline ::DataLoadedMessage* NetworkMessage::_internal_mutable_data_loaded() {
  if (!_internal_has_data_loaded()) {
    clear_data();
    set_has_data_loaded();
    data_.data_loaded_ = CreateMaybeMessage< ::DataLoadedMessage >(GetArena());
  }
  return data_.data_loaded_;
}
inline ::DataLoadedMessage* NetworkMessage::mutable_data_loaded() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.data_loaded)
  return _internal_mutable_data_loaded();
}

// .EnemyInfoMessage enemy_info = 11;
inline bool NetworkMessage::_internal_has_enemy_info() const {
  return data_case() == kEnemyInfo;
}
inline bool NetworkMessage::has_enemy_info() const {
  return _internal_has_enemy_info();
}
inline void NetworkMessage::set_has_enemy_info() {
  _oneof_case_[0] = kEnemyInfo;
}
inline void NetworkMessage::clear_enemy_info() {
...
inline ::EnemyInfoMessage* NetworkMessage::release_enemy_info() {
  // @@protoc_insertion_point(field_release:NetworkMessage.enemy_info)
  if (_internal_has_enemy_info()) {
    clear_has_data();
      ::EnemyInfoMessage* temp = data_.enemy_info_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.enemy_info_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::EnemyInfoMessage& NetworkMessage::_internal_enemy_info() const {
  return _internal_has_enemy_info()
      ? *data_.enemy_info_
      : *reinterpret_cast< ::EnemyInfoMessage*>(&::_EnemyInfoMessage_default_instance_);
}
inline const ::EnemyInfoMessage& NetworkMessage::enemy_info() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.enemy_info)
  return _internal_enemy_info();
}
inline ::EnemyInfoMessage* NetworkMessage::unsafe_arena_release_enemy_info() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.enemy_info)
  if (_internal_has_enemy_info()) {
    clear_has_data();
    ::EnemyInfoMessage* temp = data_.enemy_info_;
    data_.enemy_info_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_enemy_info(::EnemyInfoMessage* enemy_info) {
  clear_data();
  if (enemy_info) {
    set_has_enemy_info();
    data_.enemy_info_ = enemy_info;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.enemy_info)
}
inline ::EnemyInfoMessage* NetworkMessage::_internal_mutable_enemy_info() {
  if (!_internal_has_enemy_info()) {
    clear_data();
    set_has_enemy_info();
    data_.enemy_info_ = CreateMaybeMessage< ::EnemyInfoMessage >(GetArena());
  }
  return data_.enemy_info_;
}
inline ::EnemyInfoMessage* NetworkMessage::mutable_enemy_info() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.enemy_info)
  return _internal_mutable_enemy_info();
}

// .CurrentRankInfoMessage current_rank_info = 12;
inline bool NetworkMessage::_internal_has_current_rank_info() const {
  return data_case() == kCurrentRankInfo;
}
inline bool NetworkMessage::has_current_rank_info() const {
  return _internal_has_current_rank_info();
}
inline void NetworkMessage::set_has_current_rank_info() {
  _oneof_case_[0] = kCurrentRankInfo;
}
inline void NetworkMessage::clear_current_rank_info() {
...
inline ::CurrentRankInfoMessage* NetworkMessage::release_current_rank_info() {
  // @@protoc_insertion_point(field_release:NetworkMessage.current_rank_info)
  if (_internal_has_current_rank_info()) {
    clear_has_data();
      ::CurrentRankInfoMessage* temp = data_.current_rank_info_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.current_rank_info_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::CurrentRankInfoMessage& NetworkMessage::_internal_current_rank_info() const {
  return _internal_has_current_rank_info()
      ? *data_.current_rank_info_
      : *reinterpret_cast< ::CurrentRankInfoMessage*>(&::_CurrentRankInfoMessage_default_instance_);
}
inline const ::CurrentRankInfoMessage& NetworkMessage::current_rank_info() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.current_rank_info)
  return _internal_current_rank_info();
}
inline ::CurrentRankInfoMessage* NetworkMessage::unsafe_arena_release_current_rank_info() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.current_rank_info)
  if (_internal_has_current_rank_info()) {
    clear_has_data();
    ::CurrentRankInfoMessage* temp = data_.current_rank_info_;
    data_.current_rank_info_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_current_rank_info(::CurrentRankInfoMessage* current_rank_info) {
  clear_data();
  if (current_rank_info) {
    set_has_current_rank_info();
    data_.current_rank_info_ = current_rank_info;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.current_rank_info)
}
inline ::CurrentRankInfoMessage* NetworkMessage::_internal_mutable_current_rank_info() {
  if (!_internal_has_current_rank_info()) {
    clear_data();
    set_has_current_rank_info();
    data_.current_rank_info_ = CreateMaybeMessage< ::CurrentRankInfoMessage >(GetArena());
  }
  return data_.current_rank_info_;
}
inline ::CurrentRankInfoMessage* NetworkMessage::mutable_current_rank_info() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.current_rank_info)
  return _internal_mutable_current_rank_info();
}

// .BattlePrepStartMessage battle_prep_start = 13;
inline bool NetworkMessage::_internal_has_battle_prep_start() const {
  return data_case() == kBattlePrepStart;
}
inline bool NetworkMessage::has_battle_prep_start() const {
  return _internal_has_battle_prep_start();
}
inline void NetworkMessage::set_has_battle_prep_start() {
  _oneof_case_[0] = kBattlePrepStart;
}
inline void NetworkMessage::clear_battle_prep_start() {
...
inline ::BattlePrepStartMessage* NetworkMessage::release_battle_prep_start() {
  // @@protoc_insertion_point(field_release:NetworkMessage.battle_prep_start)
  if (_internal_has_battle_prep_start()) {
    clear_has_data();
      ::BattlePrepStartMessage* temp = data_.battle_prep_start_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.battle_prep_start_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::BattlePrepStartMessage& NetworkMessage::_internal_battle_prep_start() const {
  return _internal_has_battle_prep_start()
      ? *data_.battle_prep_start_
      : *reinterpret_cast< ::BattlePrepStartMessage*>(&::_BattlePrepStartMessage_default_instance_);
}
inline const ::BattlePrepStartMessage& NetworkMessage::battle_prep_start() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.battle_prep_start)
  return _internal_battle_prep_start();
}
inline ::BattlePrepStartMessage* NetworkMessage::unsafe_arena_release_battle_prep_start() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.battle_prep_start)
  if (_internal_has_battle_prep_start()) {
    clear_has_data();
    ::BattlePrepStartMessage* temp = data_.battle_prep_start_;
    data_.battle_prep_start_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_battle_prep_start(::BattlePrepStartMessage* battle_prep_start) {
  clear_data();
  if (battle_prep_start) {
    set_has_battle_prep_start();
    data_.battle_prep_start_ = battle_prep_start;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.battle_prep_start)
}
inline ::BattlePrepStartMessage* NetworkMessage::_internal_mutable_battle_prep_start() {
  if (!_internal_has_battle_prep_start()) {
    clear_data();
    set_has_battle_prep_start();
    data_.battle_prep_start_ = CreateMaybeMessage< ::BattlePrepStartMessage >(GetArena());
  }
  return data_.battle_prep_start_;
}
inline ::BattlePrepStartMessage* NetworkMessage::mutable_battle_prep_start() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.battle_prep_start)
  return _internal_mutable_battle_prep_start();
}
...
// .ExitMessage exit = 19;
inline bool NetworkMessage::_internal_has_exit() const {
  return data_case() == kExit;
}
inline bool NetworkMessage::has_exit() const {
  return _internal_has_exit();
}
inline void NetworkMessage::set_has_exit() {
  _oneof_case_[0] = kExit;
}
inline void NetworkMessage::clear_exit() {
...
inline ::ExitMessage* NetworkMessage::release_exit() {
  // @@protoc_insertion_point(field_release:NetworkMessage.exit)
  if (_internal_has_exit()) {
    clear_has_data();
      ::ExitMessage* temp = data_.exit_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.exit_ = nullptr;
...
inline const ::ExitMessage& NetworkMessage::_internal_exit() const {
  return _internal_has_exit()
      ? *data_.exit_
      : *reinterpret_cast< ::ExitMessage*>(&::_ExitMessage_default_instance_);
}
inline const ::ExitMessage& NetworkMessage::exit() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.exit)
  return _internal_exit();
}
inline ::ExitMessage* NetworkMessage::unsafe_arena_release_exit() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.exit)
  if (_internal_has_exit()) {
    clear_has_data();
    ::ExitMessage* temp = data_.exit_;
    data_.exit_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_exit(::ExitMessage* exit) {
  clear_data();
  if (exit) {
    set_has_exit();
    data_.exit_ = exit;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.exit)
}
inline ::ExitMessage* NetworkMessage::_internal_mutable_exit() {
  if (!_internal_has_exit()) {
    clear_data();
    set_has_exit();
    data_.exit_ = CreateMaybeMessage< ::ExitMessage >(GetArena());
  }
  return data_.exit_;
}
inline ::ExitMessage* NetworkMessage::mutable_exit() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.exit)
  return _internal_mutable_exit();
}

// .ExitBroadcastMessage exit_broadcast = 20;
inline bool NetworkMessage::_internal_has_exit_broadcast() const {
  return data_case() == kExitBroadcast;
}
inline bool NetworkMessage::has_exit_broadcast() const {
  return _internal_has_exit_broadcast();
}
inline void NetworkMessage::set_has_exit_broadcast() {
  _oneof_case_[0] = kExitBroadcast;
}
inline void NetworkMessage::clear_exit_broadcast() {
...
inline ::ExitBroadcastMessage* NetworkMessage::release_exit_broadcast() {
  // @@protoc_insertion_point(field_release:NetworkMessage.exit_broadcast)
  if (_internal_has_exit_broadcast()) {
    clear_has_data();
      ::ExitBroadcastMessage* temp = data_.exit_broadcast_;
    if (GetArena() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    data_.exit_broadcast_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
}
inline const ::ExitBroadcastMessage& NetworkMessage::_internal_exit_broadcast() const {
  return _internal_has_exit_broadcast()
      ? *data_.exit_broadcast_
      : *reinterpret_cast< ::ExitBroadcastMessage*>(&::_ExitBroadcastMessage_default_instance_);
}
inline const ::ExitBroadcastMessage& NetworkMessage::exit_broadcast() const {
  // @@protoc_insertion_point(field_get:NetworkMessage.exit_broadcast)
  return _internal_exit_broadcast();
}
inline ::ExitBroadcastMessage* NetworkMessage::unsafe_arena_release_exit_broadcast() {
  // @@protoc_insertion_point(field_unsafe_arena_release:NetworkMessage.exit_broadcast)
  if (_internal_has_exit_broadcast()) {
    clear_has_data();
    ::ExitBroadcastMessage* temp = data_.exit_broadcast_;
    data_.exit_broadcast_ = nullptr;
...
inline void NetworkMessage::unsafe_arena_set_allocated_exit_broadcast(::ExitBroadcastMessage* exit_broadcast) {
  clear_data();
  if (exit_broadcast) {
    set_has_exit_broadcast();
    data_.exit_broadcast_ = exit_broadcast;
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:NetworkMessage.exit_broadcast)
}
inline ::ExitBroadcastMessage* NetworkMessage::_internal_mutable_exit_broadcast() {
  if (!_internal_has_exit_broadcast()) {
    clear_data();
    set_has_exit_broadcast();
    data_.exit_broadcast_ = CreateMaybeMessage< ::ExitBroadcastMessage >(GetArena());
  }
  return data_.exit_broadcast_;
}
inline ::ExitBroadcastMessage* NetworkMessage::mutable_exit_broadcast() {
  // @@protoc_insertion_point(field_mutable:NetworkMessage.exit_broadcast)
  return _internal_mutable_exit_broadcast();
}
