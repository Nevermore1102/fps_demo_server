...
#ifndef GOOGLE_PROTOBUF_INCLUDED_src_2fproto_2fbasicMessage_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_src_2fproto_2fbasicMessage_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_src_2fproto_2fbasicMessage_2eproto
...
struct TableStruct_src_2fproto_2fbasicMessage_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_src_2fproto_2fbasicMessage_2eproto;
class TestMessage;
...
constexpr MessageType MessageType_MAX = TEST;
...
class TestMessage PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_src_2fproto_2fbasicMessage_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_src_2fproto_2fbasicMessage_2eproto;
};
// ===================================================================
...
// .MessageType msg_id = 1;
inline void TestMessage::clear_msg_id() {
  msg_id_ = 0;
}
inline ::MessageType TestMessage::_internal_msg_id() const {
  return static_cast< ::MessageType >(msg_id_);
}
inline ::MessageType TestMessage::msg_id() const {
  // @@protoc_insertion_point(field_get:TestMessage.msg_id)
  return _internal_msg_id();
}
inline void TestMessage::_internal_set_msg_id(::MessageType value) {
  
  msg_id_ = value;
}
inline void TestMessage::set_msg_id(::MessageType value) {
  _internal_set_msg_id(value);
  // @@protoc_insertion_point(field_set:TestMessage.msg_id)
}
...
inline void TestMessage::set_message(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:TestMessage.message)
}
...
inline std::string* TestMessage::unsafe_arena_release_message() {
  // @@protoc_insertion_point(field_unsafe_arena_release:TestMessage.message)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return message_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void TestMessage::unsafe_arena_set_allocated_message(
    std::string* message) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (message != nullptr) {
  ...
  message_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      message, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:TestMessage.message)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_src_2fproto_2fbasicMessage_2eproto
